...
export const OnboardingView: React.FC = () => {
  ...
  const presetOptions = [
    {
      id: 'exam',
      title: 'Example: Competitive Exam',
      subtitle: 'Syllabus tracking, sectional practice, mock tests & performance analysis.',
    ...
    {
      id: 'degree',
      title: 'Example: Higher Education Degree',
      subtitle: 'Semester subjects, lab assignments, course modules & exam schedules.',
      type: 'degree',
      color: '#38BDF8',
    },
    {
      ...
      subtitle: 'Skill tracks, practice projects, milestones & target completion dates.',
      type: 'certification',
      color: '#818CF8',
    },
    {
      id: 'course',
      title: 'Example: Online Course / Skill Track',
      subtitle: 'Module progress, weekly goals, assignments & practice logs.',
      type: 'course',
      color: '#F59E0B',
    },
  ];
